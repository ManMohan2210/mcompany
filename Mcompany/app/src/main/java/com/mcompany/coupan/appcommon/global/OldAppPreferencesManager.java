...
//
//import com.shoppersstop.apps.SSLApplication;
//import com.shoppersstop.apps.appcommon.constants.Constants;
//
//import java.util.Iterator;
//import java.util.Map;
//import java.util.WeakHashMap;
//
//public class OldAppPreferencesManager {
//    private final static String PREF_FILE = "LoginPreference";
//
//    private SharedPreferences mSharedPreferences;
//    private static volatile OldAppPreferencesManager sPreferencesManagerInstance;
//
//    private OldAppPreferencesManager() {
...
//    }
//
//    public static synchronized OldAppPreferencesManager getInstance() {
//        if (sPreferencesManagerInstance == null) { //if there is no instance available... create new one
//            synchronized (OldAppPreferencesManager.class) {
//                if (sPreferencesManagerInstance == null) sPreferencesManagerInstance = new OldAppPreferencesManager();
//            }
//        }
//        return sPreferencesManagerInstance;
//    }
//    //Make singleton from serialize and deserialize operation.
//    protected OldAppPreferencesManager readResolve() {
//        return getInstance();
//    }
//    /**
