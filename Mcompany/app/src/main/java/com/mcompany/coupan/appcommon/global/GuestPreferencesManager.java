...
import com.mcompany.coupan.McompApplication;
...
public class GuestPreferencesManager {
    private final static String PREF_FILE = "WEB_ENGAGE_SHARE_PREF";

    private SharedPreferences mSharedPreferences;
    private static volatile GuestPreferencesManager sPreferencesManagerInstance;

    private GuestPreferencesManager() {
    ...
    public static synchronized GuestPreferencesManager getInstance() {
        if (sPreferencesManagerInstance == null) { //if there is no instance available... create new one
            synchronized (GuestPreferencesManager.class) {
                if (sPreferencesManagerInstance == null) sPreferencesManagerInstance = new GuestPreferencesManager();
            }
        }
        return sPreferencesManagerInstance;
    }
    //Make singleton from serialize and deserialize operation.
    protected GuestPreferencesManager readResolve() {
        return getInstance();
    }
    /**
